...
<div class="container mx-auto px-4 py-8">
    <h1 class="text-3xl font-bold text-gray-800 mb-6">Ajouter une Copie</h1>

    <form action="{{ route('copies.store') }}" method="POST" class="bg-white shadow-md rounded-lg p-6">
        @csrf
        ...
        <div class="mb-6">
            ...
            <input type="text" name="barcode" id="barcode" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-transparent" required>
        </div>
        ...
        <div class="mb-6">
            ...
            <input type="date" name="acquisition_date" id="acquisition_date" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-transparent">
        </div>
